...
<html>
	...
	<body>
		...
		<content>
				...
				<tbody>
					<tr>
						<ul>
											...
											$affiche = "SELECT classement, prenom, nom FROM prono, coureur WHERE prono.coureur_id = coureur.id AND membre_id = '". $_SESSION['user_id'] . "' AND type='10' ORDER BY classement";
			...
			<div id="retour">
				<a href="etape9.php" class="retour">Retour</a>
			</div>
