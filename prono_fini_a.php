				...
				<tbody>
					<tr>
						<td colspan="6"><ul>
											...
											$affiche = "SELECT classement, prenom, nom FROM prono, coureur WHERE prono.coureur_id = coureur.id AND membre_id = '". $_SESSION['user_id'] . "' AND type='25' ORDER BY classement";
