				...
				<tbody>
					<tr>
						<td colspan="6"><ul>
											...
											$affiche = "SELECT classement, prenom, nom FROM prono, coureur WHERE prono.coureur_id = coureur.id AND membre_id = '". $_SESSION['user_id'] . "' AND type='23' ORDER BY classement";
												  ...
												  while ($affiche_coureur = mysql_fetch_array($affiche_result))
													{
														...
														print "</td>";
														print "<td>";
														print $affiche_coureur['prenom'] . " " . $affiche_coureur['nom'];
														print "</td>";
														print "</tr>";
